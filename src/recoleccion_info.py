...
def recolectar_materias_y_temas():
    ...
    cantidad_materias = pedir_entero(
        "\n¿Cuántas materias/exámenes querés planificar?: ",
        1,
        10
    )
    ...
    for i in range(cantidad_materias):
        ...
        cantidad_temas = pedir_entero(
            f"¿Cuántos temas tiene {nombre_materia}?: ",
            1,
            30
        )
        ...
        for j in range(cantidad_temas):
            ...
            dificultad = pedir_entero(
                "Dificultad del tema (1 a 10): ",
                1,
                10
            )

            conocimiento = pedir_entero(
                "Conocimiento previo (1 a 5): ",
                1,
                5
            )
